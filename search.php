...
<aside class="sidebar">
				...
				<nav class="menu">
					<div class="menu__body">
						...
						<div class="menu__mainmenu">
							<a href="https://blog.botbrother.ru/" class="menu__item menu__item_active">Главная</a>
		...
		<main class="main">
			...
			<div class="section">
					...
					<h2 class="section__title">Итоги поиска:</h2>
				</div>
                <?php
                    global $post;
                    ...
                    $search_results = new WP_Query(array(
                        'post_type' => 'post', // Укажите тип поста, который нужно искать (например, 'post', 'page' и т.д.)
                        's' => get_search_query(), // Получаем текущий поисковый запрос
                    ));
                        ...
                        while ($search_results->have_posts()) {
                            ...
                            <div class="post">
                                <?php if (has_post_thumbnail()) : ?>
                                    <a href="<?php the_permalink(); ?>" class="post__image image">
                                        <?php the_post_thumbnail("full", array('',''), array('class' => 'product__image')); ?>
                                    </a>
                                <?php endif; ?>
