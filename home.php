...
<aside class="sidebar">
				...
				<nav class="menu">
					<div class="menu__body">
						...
						<div class="menu__mainmenu">
							...
							<a href="/blog/" class="menu__item menu__item_active">Блог</a>
		...
		<main class="main">
			<div class="heading">
				<h1 class="heading__title">Блог сервиса BotBrother</h1>
				<div class="heading__text">В блоге мы выкладываем много полезной дополнительной информации и информируем наших пользователей обо всех изменениях</div>
			</div>
